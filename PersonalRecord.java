 ...
 * Description: It is the registered set of information about a person. 
...
public class PersonalRecord {
     ...
     * Input......: nothing
     * Output.....: nothing
     * Description: Initializes a PersonalRecord object 
     * Observation:
     */
    ...
    /**
     * @param paramPersonalDocument the official document used for identification of the person
     */
    ...
    /**
     * @param paramCompleteName the complete name of the person (no abbreviations)
     */
    ...
    /**
     * @param paramGenre the genre of the person (M - male, F - female, * - not declared)
     */
    ...
    /**
     * @param paramNationalityCode the nationality (country code where the person was born) 
     */
    ...
    /**
     * @param paramCitizenshipCode the citizenship (country code of which the person is a citizen)
     */
    ...
    /**
     * @param paramIsDisabledPerson Is a disable person (any physical or mental problem)
     */
     ...
     * Input......: nothing
     * Output.....: nothing
     * Description: print the record fields, one field by line.
     * Observation:
     */
    public void print() {
        ...
        switch (this.getPersonalDocument().getType()) {
            case 1  : System.out.println("Document type.........: " + "CPF");
                      break;
            case 2  : System.out.println("Document type.........: " + "Passport");
                      break;
            default : System.out.println("Document type.........: " + "Unknown");
        } 
    ...
    /**
     * Method.....: formatDate
     * Input......: paramStringDate - a string with a date expression
     * Output.....: the correspondent date data type or null (if an error occurs)
     * Description: Convert a string (with a date expression) to a date type
     * Observation:
     */
    /**
