...
public class Table {
     ...
     * Input......: nothing
     * Output.....: nothing
     * Description: Initializes a Table object with ZERO records
     * Observation:
     */
    public void Table() {
    ...
    /**
     * Method.....: getRecord
     * Input......: paramPosition  - position of the desired record
     * Output.....: the desired record or NULL
     * Description: If is possible, recovers the record of the desired position. 
    ...
    /**
     * Method.....: setRecord
     * Input......: paramPosition - position in which the record should be inserted
     * Description: If is correct, stores the record in the desired position
    ...
    /**
     * Method.....: addRecord
     * Input......: paramRecord - a record that will be inserted
     * Output.....: true: operation OK, false: there is an error
     * Description: Add a new record in the end of the table
     * Observation:
     */
     /**
    ...
    /**
     * Method.....: compareRecordKey
     * Input......: paramRecord1 - first record for key comparison
     *              paramRecord2 - second record for key comparison
     * Output.....: -1, if key1  LESS THAN    key2
     *               0, if key1  EQUAL   TO   key2
     *              +1, if key1  GREATER THAN key2
     * Description: Compares the keys of the records
     * Observation:
     */
     /**
      ...
      * @return -1, 0 or +1, for key1 LESS THAN, EQUAL TO, GREATER THAN key2, respectively
      */
    ...
    /**
     * Method.....: exchangeRecords
     * Input......: paramRecord1 - index of the first  record that will be exchanged
     *              paramRecord2 - index of the second record that will be exchanged 
     * Output.....: nothing
     * Description: Exchange the records in the positions specified
     * Observation:
     */
     /**
     ...
     * Method.....: isSorted
     * Input......: nothing
     * Output.....: true: the table records are ordered (strictly increasing) by the primary key
     *              false: otherwise
     * Description: Check if the table records are ordered by the primary key
     * Observation:
     */
    /**
     * 
     * @return true: if the table records are ordered (strictly increasing) by the primary key  
     */
    ...
    /**
     * Method.....: storeRecord
     * Input......: paramRecord    - record that will be stored in the table, if possible
     *              paramPosition  - position that the record will be inserted
     * Output.....: true: insertion held; false: failure to insert
     * Description: Initializes a Table object
     * Observation:
     */
    /**
     * @param paramRecord the record of a person that will be inserted in the set
     * @param paramPosition the position in which the record is inserted 
     * @return true: the storage was done, false: the was a problem, storeRecord not done.
     */
...
/**
 * Method.....: loadFromCSV
 * Input......: paramTextFileName   - the filename that was used to stored the table records
 *              paramFirstPosition  - the first position (or record) that will be loaded
 *              paramLastPosition   - the last position (or record) that will be loaded  
 * Output.....: Load, from the .CSV file, the records in a certain specified range
 * Description: Initializes a Table object
 * Observation:
 */
/**
 * @param paramTextFileName             the filename that was used to stored the table records
 * @param paramFirstPosition            the first position (or record) that will be loaded
 * @param paramLastPosition             the last position (or record) that will be loaded
 ...
 */
   public int loadFromCSV(String paramTextFileName, int paramFirstPosition, int paramLastPosition) {
    ...
    /**
     * Method.....: saveToCSV
     * Input......: paramTextFileName   - the filename that will be used to save the talbe records
     *              paramFirstPosition  - the first position (or record) that will be saved
     *              paramLastPosition   - the last position (or record) that will be saved  
     * Output.....: The number of saved records
     * Description: Save, to the .CSV file, the records in the range specified.
     * Observation:
     */   
    /**
     * @param paramTextFileName   the filename that will be used to save the table records
     * @param paramFirstPosition  the first position (or record) that will be saved
   ...
   public int saveToCSV(String paramTextFileName, int paramFirstPosition, int paramLastPosition) {
      ...
      if (paramFirstPosition > paramLastPosition) {
          ...
          if (paramLastPosition > (this.MAXIMUM_SIZE - 1)) {
              return(recordCounter);
          }
      }
    ...
    /**
     * Method.....: randomGenerateToCSV
     * Input......: paramTextFileName    - the filename that was used to stored the table records
     *              paramNumberOfRecords - the number of records that will be generated randomly 
     * Output.....: The number of generated records
     * Description: Store, to the .CSV file, the number of specified records. The records are randomly 
     *              generated.
     * Observation:
     */   
    /**
     * @param paramTextFileName             the filename that was used to stored the table records  
     * @param paramNumberOfRecords          the number of records that will be generated to storeRecord in the file
   ...
   /**
     * Method.....: print
     * Input......: paramFirstPosition  - the first position (or record) that will be saved
     *              paramLastPosition   - the last position (or record) that will be saved  
     * Output.....: The number of saved records
     * Description: Save, to the .CSV file, the records in the range specified.
     * Observation:
     */   
    /**
     * @param paramFirstPosition  the first position (or record) that will be printed
     * @param paramLastPosition   the last  position (or record) that will be printed
