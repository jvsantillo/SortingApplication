 ...
 * Description: It is the description of the official document used by one person for identification in the system 
...
public class IdentificationDocument {
    ...
    /**
     * Method.....: IdentificationDocument
     * Input......: nothing
     * Output.....: nothing
     * Description: Initializes a IdentificationDocument object with standard values
     * Observation:
    */ 
    ...
    /**
     * @param paramType the type of the document (0 - undefined, 1 - CPF, 2 - Passport)
     */
    ...
    /**
     * @param paramOriginCountryCode the country code where the document was emitted
     */
